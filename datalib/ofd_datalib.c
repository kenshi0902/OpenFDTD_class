...
void ofd_init(void)
{
	...
	_window3d[0] = _window3d[1] = _window3d[2] = _window3d[3] = 0;
...
void ofd_window3d(int width, int height, int fontsize, int fontname, double theta, double phi)
{
	_window3d[0] = width;
	_window3d[1] = height;
	_window3d[2] = fontsize;
	_window3d[3] = fontname;
	_window3dr[0] = theta;
	_window3dr[1] = phi;
}
...
void ofd_outdata(const char fn[])
{
	...
	if (_window3d[0] && _window3d[1] && _window3d[2]) {
		fprintf(fp, "window3d = %d %d %d %d %g %g\n", _window3d[0], _window3d[1], _window3d[2], _window3d[3], _window3dr[0], _window3dr[1]);
	}
